...
router.post('/sign-in/sign-in-start', (req, res) => {
  if (req.body.signinMethod === 'nhs') {
    res.redirect('/profile-manager/dentists/editor-login/sign-in/nhs-signin');
  }
  res.redirect('/profile-manager/dentists/editor-login/sign-in/non-nhs-signin');
});

router.post('/sign-in/non-nhs-signin', (req, res) => {
  res.redirect('/profile-manager/dentists/editor-login/no-profiles-landing');
});

router.post('/register/use-system-for', (req, res) => {
  res.redirect('/profile-manager/dentists/add-profiles/add-profile');
});

router.post('/sign-in/edit-profiles', (req, res) => {
  res.redirect('/profile-manager/dentists/editor-login/sign-in/edit-profiles-one-org');
});
...
router.post('/register/used-before', (req, res) => {
  if (req.body.usedBefore === "yes") {
    res.redirect('/profile-manager/dentists/editor-login/register/previous-email');
  }
  res.redirect('/profile-manager/dentists/editor-login/register/use-system-for');
});

router.post('/register/previous-email', (req, res) => {
  res.redirect('/profile-manager/dentists/editor-login/register/confirmation-code');
});

router.post('/register/confirmation-code', (req, res) => {
  res.redirect('/profile-manager/dentists/editor-login/transfer-profiles-complete');
});
